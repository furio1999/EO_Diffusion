...
def main(args):
    ...
    max_steps, posmax, end_lr = len(train_dataloader)*args.epochs, 500, 1e-06
    ...
    for i in range(args.epochs):
        ...
        for j in range(l):
            ...
            image = torch.randn((in_channels, image_size, image_size)).to(device)
