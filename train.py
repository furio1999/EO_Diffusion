...
def main(args):
    ...
    train_dataloader,test_dataloader=create_inria_dataloaders(batch_size=args.batch_size,image_size=64, num_workers=4, patch_overlap=0, device=device)
    ...
    for i in range(args.epochs):
        ...
        samples=model_ema.module.sampling(args.n_samples,clipped_reverse_diffusion=not args.no_clip,device=device, cond=cond, y=y_test) # put cond[randn_idx]*n_samples
